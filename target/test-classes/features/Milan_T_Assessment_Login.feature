...
Feature: User's management - Student - Change User's Group
  ...
  Scenario: New user's group field cannot be blank
    Given I open url "http://ask-internship.portnov.com/#/login"
    Then I type "lusineharutyunyank@gmail.com" into element with xpath "//input[@placeholder='Email *']"
    Then I type "Lus033505" into element with xpath "//input[@placeholder='Password *']"
